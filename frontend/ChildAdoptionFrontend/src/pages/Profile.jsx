...
export default function Profile() {
  ...
  const updateProfile = async (e) => {
    ...
    setMessage("");
    try {
      const { data } = await api.put("/admins/me", {
  ...
  const changePassword = async (e) => {
    ...
    setChanging(true);
    try {
      const { data } = await api.put("/admins/me/password", {
    ...
    <div>
      <div className="page-heading">
        <div>
          ...
          <h1>My Profile</h1>
          <p>
            View and update your administrator details or change your password.
          </p>
        </div>
      </div>
        ...
        <section className="page-card">
          <div className="section-title">
            ...
            <div>
              ...
              <p>Email and role are managed by the system.</p>
            </div>
          </div>
          <form onSubmit={updateProfile} className="stack-form">
        ...
        <section className="page-card">
          <div className="section-title">
            ...
            <div>
              ...
              <p>You will need to sign in again after changing it.</p>
            </div>
          </div>
